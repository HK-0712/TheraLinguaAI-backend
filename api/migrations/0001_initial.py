    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sug_lvl', models.CharField(blank=True, help_text='Suggested difficulty level', max_length=20)),
                ('cur_lvl', models.CharField(default='Kindergarten', help_text='Current difficulty level', max_length=20)),
