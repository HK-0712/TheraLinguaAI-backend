    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sug_lvl', models.CharField(blank=True, help_text='基於初次測試結果的建議難度等級', max_length=20)),
                ('cur_lvl', models.CharField(default='Easy', help_text='使用者自己選擇的當前難度等級', max_length=20)),
            ],
        ),
        migrations.CreateModel(
